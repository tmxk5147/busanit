...
# 2번 문제/ while문을 사용해 1부터 1000까지의 자연수 중 3의 배수의 합을 구해 보자.
result = 0
i = 1
while i <= 1000:
...
# 3번 문제/ while문을 사용하여 다음과 같이 별(*)을 표시하는 프로그램을 작성해 보자
# *
# **
# ***
# ****
...
# 4번 문제/ for문을 사용해 1부터 100까지의 숫자를 출력해 보자.
for i in range(1,101):
    print(i)
    
# 5번 문제/ A 학급에 총 10명의 학생이 있다. 이 학생들의 중간고사 점수는 다음과 같다.
